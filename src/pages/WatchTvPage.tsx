    ...
    <div className="min-h-screen bg-[#05070a] text-[#f5f5f7] pt-20 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-[11px] sm:text-xs text-zinc-400 mb-5 font-medium tracking-wide">
          ...
          <span className="text-zinc-600">›</span>
          <Link to={`/series/${series.id}`} className="text-zinc-300 hover:text-white transition-colors truncate max-w-[160px] sm:max-w-[220px]">
            {title}
          </Link>
          <span className="text-zinc-600">›</span>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
          ...
          <div className="lg:col-span-2 rounded-3xl bg-[#101014]/80 backdrop-blur-3xl border border-white/[0.08] shadow-[0_25px_60px_rgba(0,0,0,0.85)] p-6 sm:p-8 relative z-10 overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                <span className="px-2.5 py-0.5 rounded-full bg-white/[0.08] text-zinc-300 text-[10px] font-semibold uppercase tracking-wider">
                  Full HD
                </span>
                {series.certification && (
                  <span className="px-2 py-0.5 rounded-md bg-white/[0.12] text-[10px] font-extrabold text-white">
                    {series.certification}
                  </span>
                )}
                {currentEpisodeObj?.vote_average ? (
                  <span className="flex items-center gap-1 text-xs text-amber-300 font-bold bg-amber-400/10 px-2 py-0.5 rounded-full border border-amber-400/20">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-zinc-400 font-medium pt-2">
            ...
            <div className="mt-8 pt-6 border-t border-white/[0.08] flex flex-wrap items-center justify-between gap-4 relative z-10">
              <div className="flex flex-wrap items-center gap-2.5">
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold transition-all ${inWatchlist
                ...
                {primaryTrailer && (
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2.5 rounded-full text-xs font-semibold bg-white/[0.08] hover:bg-white/[0.16] text-white border border-white/[0.14] transition-all backdrop-blur-xl"
                  >
                ...
                <button
                  ...
                  className={`p-2.5 rounded-full border transition-all text-xs ${inFavorites
                ...
                <button
                  onClick={handleShare}
                  className="p-2.5 bg-white/[0.08] hover:bg-white/[0.16] text-white rounded-full border border-white/[0.14] transition-all"
                  title="Share link"
                >
              ...
              <Link
                to={`/series/${series.id}`}
                className="flex items-center gap-2 px-4 py-2.5 rounded-full text-xs font-semibold bg-white/[0.08] hover:bg-white/[0.16] text-zinc-300 hover:text-white border border-white/[0.12] transition-colors"
              >
